...
export default function WizardStep2({ DTO, setDTO }) {
    ...
    const [lstFeeMax, setLstFeeMax] = useState([
            'Less 5 millions VND',
            '5 to 15 million VND',
            '15 to 30 million VND',
            '30 to 50 million VND',
        ]);
            ...
            <div className="form-wizard-content">
                <Form>
                    ...
                    <FormGroup row>
                        ...
                        Which of the following best describes the highest level of formal education you have completed?
                        </Label>
                        <Col sm={7}>
                    ...
                    <FormGroup row>
                        <Label sm={4}>
                        Could you please let us know your current place of residence?
                        </Label>
                        <Col sm={7}>
                    ...
                    <FormGroup row>
                        <Label for="examplePassword" sm={4}>
                        What is your budget for enrolling in courses?
                        </Label>
                        <Col sm={7}>
                    ...
                    <FormGroup row>
                        <Label for="exampleSelectMulti" sm={4}>
                        If we were to offer offline classes, what time would be most convenient for you?
                        </Label>
                        <Col sm={2}>
                            Start time
                            <Input
                    ...
                    <FormGroup row>
                        <Label for="examplePassword" sm={4}>
                            What will you do to develop yourself in the near future?
                        </Label>
                        <Col sm={7}>
