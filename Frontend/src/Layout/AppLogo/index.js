    ...
    return (
      <Fragment>
        <div className="app-header__logo" style={{ width: "auto" }}>
          <Link to="/" style={{fontFamily: 'cursive', color: 'white'}}>
            <img src='/images/navbars/logo.png' alt='logo' style={{width: '30px'}} className="rounded-circle mr-1"/>
            COURSE ADVISOR HCMUS
          </Link>
